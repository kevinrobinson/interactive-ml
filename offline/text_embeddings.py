...
#     console.log('embedding text...', text, index);
#     const embeddingTensor = await model.embed([text]);
#     console.log('  fetching...', text, index);
...
# // from https://github.com/tensorflow/tfjs-examples/blob/master/mobilenet/imagenet_classes.js
